...
//This version reads from folder in console
//in this version, you can provide folder name instead of file name to read all files in the test folder
//in this version, you can provide folder name instead of file name to read all files in the test folder
//in this version, you can provide folder name instead of file name to read all files in the test folder
//in this version, you can provide folder name instead of file name to read all files in the test folder


public class StringReversalV2 {
    //Let's define our MAX value to check if sorting is possible or not!
    static final BigInteger inf = new BigInteger("1000000000000000000000000000000000000000000000000000");

    //Pass list parameter with full of strings
    private String stringReversal(List<String> strings) {
        int n = strings.size();
    ...
    public static void main(String[] args) {
        ...
        //you can provide folder name instead of file name to read all files in the test folder
        Scanner in = new Scanner(System.in);
        String filePath = in.nextLine();

        StringReversalV2 obj = new StringReversalV2();
